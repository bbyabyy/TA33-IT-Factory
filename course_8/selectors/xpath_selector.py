...
XPATH esre folosit sa navigheze prin nodurile XML
...
"""
# example
chrome.find_element(By.XPATH, "//ul[@class='mainMenuList parent-1']//"
                              "following::a")
...
"""
chrome.find_element(By.XPATH, "//ul[@class='WbrtSideMenu has-grandchildren']"
                              "//following::ul[@class='submenu-list']"
...
"""
preceding-sibling: selecteaza toate nodurile care au acelasi parinte ca nodul curent si apar inainte de nodul curent
syntax: //tagname[@attribute='value']//preceding-sibling::tagname
"""
chrome.find_element(By.XPATH, "//ul@class='WbrtSideMenu ")
"""
